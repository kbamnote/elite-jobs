      ...
      <div className="mt-16 bg-white rounded-2xl p-8 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h4 className="text-xl font-semibold mb-2" style={{ color: '#e94560' }}>High Demand Roles</h4>
          ...
          <div className="text-center">
            <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: '#fef2f2' }}>
              <svg className="w-8 h-8" fill="#e94560" viewBox="0 0 24 24">
                <path fill="#e94560" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h4 className="text-xl font-semibold mb-2" style={{ color: '#e94560' }}>Salary Insights</h4>
          ...
          <div className="text-center">
            ...
            <h4 className="text-xl font-semibold mb-2" style={{ color: '#e94560' }}>Growth Opportunities</h4>
